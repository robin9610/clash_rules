...
// https://ghproxy.net/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Telegram/Telegram.yaml
// https://ghproxy.net/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Telegram/Telegram.yaml
// https://ghproxy.com/https://ghproxy.net/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Telegram/Telegram.yaml
...
const dnsConfig = {
	...
	// 'default-nameserver': ['119.29.29.29', '223.5.5.5', '1.1.1.1', '8.8.8.8', '2400:3200::1', '2402:4e00::'],
...
const snifferConfig = {
	...
	'force-domain': ['+.v2ex.com'], // 强制嗅探 别乱加

	'skip-domain': ['rule-set:ChinaMax_Domain,custom-direct', 'Mijia Cloud', '+.push.apple.com', '+.wechat.com', '+.qpic.cn', '+.qq.com', '+.wechatapp.com'], // 忽略嗅探
}
// 规则集通用配置
...
const ruleProviders = {
	...
	// 	...ruleProviderCommon,
	// 	behavior: 'classical',
	// 	url: 'https://ghproxy.net/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Twitter/Twitter.yaml',
	// 	path: './ruleset/X.yaml',
	// },
	'YouTubeMusic': {
		...ruleProviderCommon,
	...
	// 	...ruleProviderCommon,
	// 	behavior: 'ipcidr',
	// 	url: 'https://ghproxy.net/https://raw.githubusercontent.com/MetaCubeX/meta-rules-dat/meta/geo/geoip/telegram.yaml',
	...
	// 	...ruleProviderCommon,
	// 	behavior: 'classical',
	// 	url: 'https://ghproxy.net/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Apple/Apple_Classical.yaml',
	...
	// 	...ruleProviderCommon,
	// 	behavior: 'classical',
	// 	url: 'https://ghproxy.net/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Discord/Discord.yaml',
...
function main(config) {
	...
	const repColde =
		/剩|流量|ISP|到|重|防|电报|群组|频道|维护|付费|官|更新|United States|America|USA|US|🇺🇸|美国|SG|🇸🇬|新加坡|Singapore|JP|🇯🇵|日本|Japan|港|HK|Hong Kong|HongKong|🇭🇰|台|TAIWAN|TW|TAI WAN|🇹🇼|韩国|KR|Korea|KOR|🇰🇷/i
	const repAll = /剩|流量|ISP|到|重|防|电报|群组|频道|维护|付费|官|更新/i
	...
	config['proxy-groups'] = [
		...
		// 	type: 'select',
		// 	proxies: ['日本节点 🇯🇵', '美国节点 🇺🇸', '新加坡节点 🇸🇬', '地区选择 🌍', '手动选择 👌'],
		// 	icon: 'https://ghproxy.net/https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/X.png',
		// },
		// 蒸汽平台 🎮
		{
			...groupBaseOption,
